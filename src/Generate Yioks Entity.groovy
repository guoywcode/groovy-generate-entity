...
def generate(table, dir) {
    ...
    packageName = getPackageName(dir,"entity")
    generateEntity(table, path)
}

// 生成实体类
def generateEntity(table, path){
    def className = javaName(table.getName(), true)
    new File(path,className+"Entity.java").withPrintWriter {
...
def writerEntity(out, table){
    ...
    out.println "import com.yioks.core.base.model.UuidBaseJpaModel;"
    ...
    out.println "public class $className extends UuidBaseJpaModel {"
    out.println ""
